...
class Logger():
    ...
    def inputImport(self,adc0,adc1,adc2,adc3,printFunc):
        ...
        try:
            ...
            adcPinMap = {
                "0AX": {
                    "0A0": AnalogIn(ads=adc0, positive_pin=ADS.P0),
                    "0A1": AnalogIn(ads=adc0, positive_pin=ADS.P1),
                    "0A2": AnalogIn(ads=adc0, positive_pin=ADS.P2),
                    "0A3": AnalogIn(ads=adc0, positive_pin=ADS.P3)
                },
                "1AX": {
                    "1A0": AnalogIn(ads=adc1, positive_pin=ADS.P0),
                    "1A1": AnalogIn(ads=adc1, positive_pin=ADS.P1),
                    "1A2": AnalogIn(ads=adc1, positive_pin=ADS.P2),
                    "1A3": AnalogIn(ads=adc1, positive_pin=ADS.P3)
                },
                "2AX": {
                    "2A0": AnalogIn(ads=adc2, positive_pin=ADS.P0),
                    "2A1": AnalogIn(ads=adc2, positive_pin=ADS.P1),
                    "2A2": AnalogIn(ads=adc2, positive_pin=ADS.P2),
                    "2A3": AnalogIn(ads=adc2, positive_pin=ADS.P3)
                },
                "3AX": {
                    "3A0": AnalogIn(ads=adc3, positive_pin=ADS.P0),
                    "3A1": AnalogIn(ads=adc3, positive_pin=ADS.P1),
                    "3A2": AnalogIn(ads=adc3, positive_pin=ADS.P2),
                    "3A3": AnalogIn(ads=adc3, positive_pin=ADS.P3)
                }
            }
